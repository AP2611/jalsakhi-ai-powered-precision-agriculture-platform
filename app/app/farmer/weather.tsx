    ...
    <ScreenWrapper>
      ...
      <View style={styles.content}>
        <BlurView intensity={80} tint="light" style={styles.premiumPlaceholder}>
          ...
          >
            <MaterialCommunityIcons name="weather-partly-cloudy" size={80} color={Theme.colors.forest} />
          </LinearGradient>
          
          <Text style={styles.placeholderTitle}>Weather Intelligence</Text>
          <Text style={styles.placeholderText}>
            We are integrating hyper-local satellite weather data to provide you with high-precision, farm-specific rainfall predictions and micro-climate insights.
          </Text>
